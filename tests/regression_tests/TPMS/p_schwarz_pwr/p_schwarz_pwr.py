...
fuel_thickness = 0.1
tpms_fuel1 = openmc.TPMS.from_thickness("Schwarz_P", -fuel_thickness/2, pitch=1.)
tpms_fuel2 = openmc.TPMS.from_thickness("Schwarz_P", +fuel_thickness/2, pitch=1.)
clad_thickness = 0.05
tpms_clad1 = openmc.TPMS.from_thickness("Schwarz_P", -(fuel_thickness+clad_thickness)/2, pitch=1.)
tpms_clad2 = openmc.TPMS.from_thickness("Schwarz_P", +(fuel_thickness+clad_thickness)/2, pitch=1.)
